...
def menu():
	...
	print(p+"╠══[{"+k+"3"+h+"}"+l+" Crack Pertemanan Publik "+k+"{"+h+"Massal"+k+"}")
	print(p+"╠══[{"+k+"4"+h+"}"+l+" Crack Akun Old 04/08 "+k+"{"+h+"Massal"+k+"}")
	print(p+"╠══[{"+k+"5"+h+"}"+l+" Crack Akun Old 04/10 "+k+"{"+h+"Massal"+k+"}")
	print(p+"╠══[{"+k+"6"+h+"}"+l+" Setting User Agent")
